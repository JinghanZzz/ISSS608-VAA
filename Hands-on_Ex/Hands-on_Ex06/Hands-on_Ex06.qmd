...
![By the end of this section, you will be able to:](images/clipboard-2109882774.png)
...
::: callout-note
Beside extracting the necessary data into *attacks* data frame, of **dplyr** package is used to convert *wkday* and *hour* fields into **factor** so they’ll be ordered when plotting`mutate()`
:::
...
-   a new field called *n* is derived by using and functions.`group_by()count()`

-   `na.omit()` is used to exclude missing value.

-   `geom_tile()` is used to plot tiles (grids) at each x and y position. and arguments are used to specify the border color and line size of the tiles.`colorsize`
...
![](images/clipboard-996519829.png)
...
![](images/clipboard-1912161417.png)
...
### **17.5.5 Plotting the Circle Plot**
...
Before getting start, make sure that **CGPfunctions** has been installed and loaded onto R environment. Then, refer to [Using newggslopegraph](https://cran.r-project.org/web/packages/CGPfunctions/vignettes/Using-newggslopegraph.html) to learn more about the function. Lastly, read more about and its arguments by referring to this [link](https://www.rdocumentation.org/packages/CGPfunctions/versions/0.6.3/topics/newggslopegraph).`newggslopegraph()`
...
::: callout-tip
Takeaway from the code above:

For effective data visualisation design, is used convert the value type of *Year* field from numeric to factor.`factor()`
:::
