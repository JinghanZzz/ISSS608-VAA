...
This web page consists of hands-on exercise for 5 different types of visualisations: **Chap13 Ternary Plot, Chap06 Visual Correlation Analysis, Chap14 Heatmap, Chap15 Parallel Coordinates Plot**, and **Chap16 Treemap.**
...
-   [**parallelPlot**](https://cran.r-project.org/web/packages/parallelPlot/parallelPlot.pdf) argument is used to plot histogram along the axis of each variables.
...
see  [Pipes in R Tutorial For Beginners](https://www.datacamp.com/community/tutorials/pipe-r-tutorial). for detail.
